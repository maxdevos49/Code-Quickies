...
int main(void) {
  ...
  //   glm_mat4_identity(identity_matrix); // Init matrix to identity

  //   vec3 axis = {0.0f, 0.0f, 1.0f};
  //   glm_scale(identity_matrix, (vec3){0.5f, 0.5f, 0.0f});
  //   glm_translate(identity_matrix, (vec3){-1.0f, 1.0f, 0.0f});
  //   glm_rotate(identity_matrix, 1, axis);
